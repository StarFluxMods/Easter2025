...
using Easter2025.Customs.Processes;
...
#region Process
public static Process SearchBush => (Process)GDOUtils.GetCustomGameDataObject<SearchBush>().GameDataObject;
#endregion
...
public static Item OrangePlasticEgg => (Item)GDOUtils.GetCustomGameDataObject<OrangePlasticEgg>().GameDataObject;
public static Item PinkPlasticEgg => (Item)GDOUtils.GetCustomGameDataObject<PinkPlasticEgg>().GameDataObject;
...
public static Item YellowPlasticEgg => (Item)GDOUtils.GetCustomGameDataObject<YellowPlasticEgg>().GameDataObject;
#endregion
...
public static Appliance Bush => (Appliance)GDOUtils.GetCustomGameDataObject<Bush>().GameDataObject;
